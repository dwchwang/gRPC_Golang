...
const file_user_proto_rawDesc = "" +
	...
	"\x05limit\x18\x01 \x01(\x05R\x05limit2\xc9\x01\n" +
	"\vUserService\x12?\n" +
	"\n" +
	...
	"\tListUsers\x12\x15.user.UserListRequest\x1a\x18.user.CreateUserResponse0\x01B\x0eZ\fgrpc-demo/pbb\x06proto3"
...
var file_user_proto_depIdxs = []int32{
	...
	1, // 4: user.UserService.GetUser:output_type -> user.CreateUserResponse
	1, // 5: user.UserService.ListUsers:output_type -> user.CreateUserResponse
